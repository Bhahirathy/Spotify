                ...
                <Row className=" border-none">
                    ...
                    <Col xs={12} sm={12} md={8} lg={4} className="mt-3 min-vh-100 bg-transparent border-none">
                        <div className="row-sm trackList">
                            ...
                            <Search data={data} setData={setData} setInputClicked={setInputClicked} inputClassName={inputClassName} />
                            ...
                            <Card className="bg-transparent link-light mt-3 mb-3">
                                {!clicked ? (data?.map((val, index) => {
                                    ...
                                    if (val.top_track) {
                                        return (
                                            <>
                                                <Card key={val?.id} onClick={() => { handleSong(val?.url, val.cover, val.name, val.artist) }} className={`song-card link-light ${index === selectedCard ? "selected-card" : ""}`}>
                                                    <div className="songItem align-items-center ">
                                                        <div className="gap-3 d-flex ">
